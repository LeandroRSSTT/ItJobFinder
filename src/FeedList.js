...
const FeedList = () => {
    ...
    return (
        <div>
            {newItems.length > 0 && (
                <div className="mt-8 mb-4">
                    ...
                    <div className="flex flex-wrap justify-center">
                        {newItems.map((item) => (
                            <div key={item.guid} className="card w-96 m-4 bg-neutral text-neutral-content">
                                <div className="card-body">
                                    <h3 className="card-title text-primary-content">{item.title}</h3>
                                    <hr />
                                    <p className="mt-4">
                                    ...
                                    <div className="card-actions mt-auto">
                                        <a href={item.link} target="_blank" rel="noreferrer" className="btn btn-primary btn-sm w-full">
                                            Voir l'offre
                                        </a>
                                    </div>
                                </div>
            ...
            <div className="text-center">
                <h1 className="text-4xl font-bold mt-8 mb-4">Toutes les offres d'emploi</h1>
            </div>
            <div className="flex flex-wrap justify-center">
                {oldItems.map((item) => (
                    <div key={item.guid} className="card w-96 m-4 bg-neutral text-neutral-content">
                        ...
                        <div className="card-actions">
                            <a href={item.link} target="_blank" rel="noreferrer" className="btn btn-primary m-8">
                                Voir l'offre
                            </a>
                        </div>
                    </div>
