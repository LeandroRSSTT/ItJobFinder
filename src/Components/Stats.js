...
const Stats = ({ totalJobs, newJobs }) => {
  return (
    <div className="stats flex justify-center mx-auto w-full sm:w-1/3 md:w-1/3">
      <div className="stat bg-primary text-primary-content ml-4 mr-0 sm:mr-8 rounded-lg">
      ...
      <div className="stat bg-primary text-primary-content mr-4 rounded-lg">
        <div className="stat-figure">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block w-8 h-8 stroke-current">
