...
for i in range(10):
    ...
    for job in jobs:
        ...
        job_dict['title'] = title_parts[0].strip()
        ...
        if days_ago:
            ...
            job_dict['pubDate'] = real_date.strftime('%a, %d %b %Y %H:%M:%S %z')
        else:
            ...
            if months_ago:
                ...
                try:
                    ...
                    job_dict['pubDate'] = None

        job_dict['link'] = base_url + job.find('a')['href']
        job_dict['from'] = 'AW'
        job_dict['description'] = 'No description'
        job_list.append(job_dict)


# Chemin du dossier 'datas' par rapport au dossier courant
datas_folder = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'src', 'datas')
